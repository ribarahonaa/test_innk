...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { gender: @series.gender, price: @series.price, season: @series.season, title: @series.title } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { gender: @series.gender, price: @series.price, season: @series.season, title: @series.title } }
